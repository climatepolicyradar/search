...
FEEDS = [
    ...
    {
        "name": "search-vespa-feeder-documents-passages",
        "s3_key": "search/vespa/documents_passages_feed_materializer.jsonl",
        "description": "Feed documents passages JSONL from S3 into Vespa",
    },
    {
    ...
    {
        "name": "search-vespa-feeder-documents-principal-passages",
        "s3_key": "search/vespa/documents_principal_passages_feed_materializer.jsonl",
        "description": "Feed documents principal passages JSONL from S3 into Vespa",
    },
    # Passages
    {
