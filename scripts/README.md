...
This means that you shouldn't necessarily expect code in the `ephemeral/` dir to work consistently or be maintained. But if you find yourself reaching for code in this dir often, you might want to move it and add some tests.
