...
from search.engines.dev_vespa import DevVespaPrincipalDocumentSearchEngine, Settings
...
def search(
    ...
    """Search for principal documents."""
    engine = DevVespaPrincipalDocumentSearchEngine(
